...
var PinchScrollZoomAxis = /** @class */ (function () {
    function PinchScrollZoomAxis(size, origin, translate) {
        this._point = 0;
        this._start1 = 0;
        this._start2 = 0;
    ...
    PinchScrollZoomAxis.prototype.resetOrigin = function () {
        this._origin = this._size / 2;
    };
    PinchScrollZoomAxis.prototype.resetPoint = function (scale) {
        if (scale < 1) {
            this._point = 0;
            return;
        }
...
var script = /*#__PURE__*/ Vue.extend({
    ...
    data: function () {
        return {
            ...
            axisY: new PinchScrollZoomAxis(this.height, this.originY, this.translateY),
            throttleDoDrag: lodash.throttle(this.doDragEvent, this.throttleDelay),
            stopScalling: lodash.debounce(this.doStopScallingEvent, 200),
            zoomIn: false,
            zoomOut: false,
        };
    },
    methods: {
        ...
        startDrag: function (touchEvent) {
            ...
            var clientX1 = touchEvent.touches[0].clientX;
            var clientY1 = touchEvent.touches[0].clientY;
            if (touchEvent.touches.length > 1) {
                this.touch1 = true;
                this.touch2 = true;
                this.startScale = this.currentScale;
                var clientX2 = touchEvent.touches[1].clientX;
                var clientY2 = touchEvent.touches[1].clientY;
        ...
        doDragEvent: function (touchEvent) {
            ...
            if (!this.touch1 || (!this.touch2 && touchEvent.touches.length === 2))
                this.startDrag(touchEvent);
            if (this.touch1 && this.touch2) {
                this.axisX.dragPinch(touchEvent.touches[0].clientX, touchEvent.touches[1].clientX);
                this.axisY.dragPinch(touchEvent.touches[0].clientY, touchEvent.touches[1].clientY);
            }
            else {
        ...
        doScale: function (touchEvent) {
            ...
            var distance = this.getDistance(touch1.clientX, touch1.clientY, touch2.clientX, touch2.clientY);

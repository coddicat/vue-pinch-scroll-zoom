...
var PinchScrollZoom = /** @class */ (function (_super) {
    __extends(PinchScrollZoom, _super);
    function PinchScrollZoom() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.touch1 = false;
        _this.touch2 = false;
        _this.currentScale = _this.scale;
        _this.startScale = _this.scale;
        _this.axisX = new PinchScrollZoomAxis(_this.width, _this.originX, _this.translateX, _this.contentWidth);
        _this.axisY = new PinchScrollZoomAxis(_this.height, _this.originY, _this.translateY, _this.contentHeight);
        _this.throttleDoDrag = lodash.throttle(_this.doDragEvent, _this.throttleDelay);
        _this.stopScaling = lodash.debounce(_this.doStopScalingEvent, 200);
        _this.zoomIn = false;
        _this.zoomOut = false;
        _this.stopDragListener = false;
        _this.startDragListener = false;
        _this.draggingListener = false;
        _this.scalingListener = false;
        return _this;
    }
    Object.defineProperty(PinchScrollZoom.prototype, "componentStyle", {
        get: function () {
            return {
                width: this.width + "px",
    ...
    Object.defineProperty(PinchScrollZoom.prototype, "componentClass", {
        get: function () {
            return {
    ...
    Object.defineProperty(PinchScrollZoom.prototype, "containerStyle", {
        get: function () {
    ...
    PinchScrollZoom.prototype.scaleChanged = function (val) {
        this.submitScale(val);
    };
    PinchScrollZoom.prototype.translateXchanged = function (val) {
        this.axisX.setPoint(val);
    };
    PinchScrollZoom.prototype.translateYchanged = function (val) {
        this.axisY.setPoint(val);
    };
    PinchScrollZoom.prototype.originXchanged = function (val) {
        this.axisX.setOrigin(val);
    };
    PinchScrollZoom.prototype.originYchanged = function (val) {
        this.axisY.setOrigin(val);
    };
    PinchScrollZoom.prototype.withinChanged = function () {
        this.checkWithin();
    };
    PinchScrollZoom.prototype.setData = function (data) {
    ...
    PinchScrollZoom.prototype.getEmitData = function () {
        return {
            x: this.axisX.point,
            y: this.axisY.point,
    ...
    PinchScrollZoom.prototype.stopDrag = function () {
        this.touch1 = false;
        this.touch2 = false;
        this.zoomIn = false;
        this.zoomOut = false;
    ...
    PinchScrollZoom.prototype.startDrag = function (touchEvent) {
        if (!this.draggable)
            return;
    ...
    PinchScrollZoom.prototype.doDrag = function (touchEvent) {
        if (!this.draggable)
            return;
        this.throttleDoDrag(touchEvent);
    };
    PinchScrollZoom.prototype.doStopScalingEvent = function () {
        this.zoomIn = false;
        this.zoomOut = false;
    };
    PinchScrollZoom.prototype.doDragEvent = function (touchEvent) {
    ...
    PinchScrollZoom.prototype.getBoundingTouchClientX = function (touch) {
        return touch.clientX - this.$el.getBoundingClientRect().left;
    };
    PinchScrollZoom.prototype.getBoundingTouchClientY = function (touch) {
        return touch.clientY - this.$el.getBoundingClientRect().top;
    };
    PinchScrollZoom.prototype.submitDrag = function () {
        if (this.draggingListener) {
            this.$emit("dragging", this.getEmitData());
        }
    };
    PinchScrollZoom.prototype.getDistance = function (x1, y1, x2, y2) {
        var sqrDistance = Math.pow((x1 - x2), 2) + Math.pow((y1 - y2), 2);
        var distance = Math.sqrt(sqrDistance);
        return distance;
    };
    PinchScrollZoom.prototype.doScale = function (touchEvent) {
    ...
    PinchScrollZoom.prototype.submitScale = function (scale) {
    ...
    PinchScrollZoom.prototype.doWheelScale = function (event) {
    ...
    PinchScrollZoom.prototype.checkWithin = function () {
        if (!this.within) {
            return;
        }
    ...
    PinchScrollZoom.prototype.mounted = function () {
    ...
    PinchScrollZoom.prototype.beforeDestroy = function () {
    ...
    ], PinchScrollZoom.prototype, "contentWidth", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false })
    ], PinchScrollZoom.prototype, "contentHeight", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: true })
    ], PinchScrollZoom.prototype, "width", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: true })
    ], PinchScrollZoom.prototype, "height", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false })
    ], PinchScrollZoom.prototype, "originX", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false })
    ], PinchScrollZoom.prototype, "originY", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: 0 })
    ], PinchScrollZoom.prototype, "translateX", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: 0 })
    ], PinchScrollZoom.prototype, "translateY", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: 1 })
    ], PinchScrollZoom.prototype, "scale", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: 25 })
    ], PinchScrollZoom.prototype, "throttleDelay", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: true })
    ], PinchScrollZoom.prototype, "within", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: 0.3 })
    ], PinchScrollZoom.prototype, "minScale", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: 5 })
    ], PinchScrollZoom.prototype, "maxScale", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: 0.001 })
    ], PinchScrollZoom.prototype, "wheelVelocity", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: true })
    ], PinchScrollZoom.prototype, "draggable", void 0);
    __decorate([
        vuePropertyDecorator.Watch("scale")
    ], PinchScrollZoom.prototype, "scaleChanged", null);
    __decorate([
        vuePropertyDecorator.Watch("translateX")
    ], PinchScrollZoom.prototype, "translateXchanged", null);
    __decorate([
        vuePropertyDecorator.Watch("translateY")
    ], PinchScrollZoom.prototype, "translateYchanged", null);
    __decorate([
        vuePropertyDecorator.Watch("originX")
    ], PinchScrollZoom.prototype, "originXchanged", null);
    __decorate([
        vuePropertyDecorator.Watch("originY")
    ], PinchScrollZoom.prototype, "originYchanged", null);
    __decorate([
        vuePropertyDecorator.Watch("within")
    ], PinchScrollZoom.prototype, "withinChanged", null);
    PinchScrollZoom = __decorate([
        vuePropertyDecorator.Component({
            name: "PinchScrollZoom",
        })
    ], PinchScrollZoom);
    return PinchScrollZoom;
...
/* script */
const __vue_script__ = PinchScrollZoom;
...
exports.PinchScrollZoom = __vue_component__;
